...
$query = "SELECT * FROM Hardware LEFT JOIN HardwareDisplay ON Hardware.HardwareType=HardwareDisplay.ID LEFT JOIN Manufacturer ON Hardware.Manufacturer=Manufacturer.Manufacturer LEFT JOIN HardwareType ON Hardware.HardwareType=HardwareType.Type AND Hardware.SubType=HardwareType.SubType WHERE Client='".$compid."' AND HardwareDisplay.DisplayName='".$name."' AND Hardware.Removed IS NULL";
if ($name !== "Partition"){
	$query.=" AND Hardware.Model IS NOT NULL";
}
...
<body topmargin="0" marginheight="0" marginwidth="0" leftmargin="0" bgcolor="#EFF7FF">
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr>
			...
			<td background="images/gradientbg.gif" nowrap><span class="header1">&nbsp;&nbsp;<?php echo $name?> Information&nbsp;</span></td>
		...
		<tr>
			...
			<td background="images/title.gif" nowrap colspan="2"><span class="header1">&nbsp;&nbsp;<?php print trim($row["Model"]);?>&nbsp;</span></td>
