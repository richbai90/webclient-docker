...
if (!$query) $query = "SELECT DISTINCT Manufacturer.Name, Manufacturer.Manufacturer FROM SoftwareRecognisedPrimary JOIN Manufacturer ON SoftwareRecognisedPrimary.Manufacturer = Manufacturer.Manufacturer WHERE SoftwareRecognisedPrimary.Client='".$compid."' ORDER BY Manufacturer.Name";
