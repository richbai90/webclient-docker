...
$query = "SELECT *, SRDProduct.Name AS FileName, Manufacturer.Name AS ManuName, ProductType.Name AS ProdName FROM SoftwareRecognisedPrimary LEFT JOIN SRDProduct ON SoftwareRecognisedPrimary.SRDProduct=SRDProduct.SRDProduct LEFT JOIN Manufacturer ON SoftwareRecognisedPrimary.Manufacturer=Manufacturer.Manufacturer LEFT JOIN ProductType ON SoftwareRecognisedPrimary.ProductType=ProductType.ProductType LEFT JOIN SRDVersion ON SoftwareRecognisedPrimary.SRDVersion=SRDVersion.SRDVersion LEFT JOIN defUsage ON SoftwareRecognisedPrimary.Frequency=defUsage.ID LEFT JOIN defShortcutLocation ON SoftwareRecognisedPrimary.ShortcutLocation=defShortcutLocation.ID WHERE SoftwareRecognisedPrimary.Client='".$compid."' AND SoftwareRecognisedPrimary.ShortcutLocation='".$accessid."' ORDER BY Manufacturer.Name";
