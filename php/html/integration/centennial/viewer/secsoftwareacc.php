...
$query = "SELECT *, SRDProduct.Name AS FileName, Manufacturer.Name AS ManuName, ProductType.Name AS ProdName FROM SoftwareRecognisedSecondary LEFT JOIN SRDProduct ON SoftwareRecognisedSecondary.SRDProduct=SRDProduct.SRDProduct LEFT JOIN Manufacturer ON SoftwareRecognisedSecondary.Manufacturer=Manufacturer.Manufacturer LEFT JOIN ProductType ON SoftwareRecognisedSecondary.ProductType=ProductType.ProductType LEFT JOIN SRDVersion ON SoftwareRecognisedSecondary.SRDVersion=SRDVersion.SRDVersion LEFT JOIN defUsage ON SoftwareRecognisedSecondary.Frequency=defUsage.ID LEFT JOIN defShortcutLocation ON SoftwareRecognisedSecondary.ShortcutLocation=defShortcutLocation.ID WHERE SoftwareRecognisedSecondary.Client='".$compid."' AND SoftwareRecognisedSecondary.ShortcutLocation='".$accessid."' ORDER BY Manufacturer.Name";
