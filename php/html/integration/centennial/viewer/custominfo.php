...
$query = "SELECT *, Plugin.FieldName AS NameField FROM Plugin LEFT JOIN CustomDataFields ON Plugin.FieldName=CustomDataFields.FieldName WHERE Client='".$compid."' ORDER BY CustomDataFields.FieldID";
...
<body topmargin="0" marginheight="0" marginwidth="0" leftmargin="0" bgcolor="#EFF7FF">
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr>
			...
			<td background="images/gradientbg.gif" nowrap colspan="3"><span class="header1">&nbsp;&nbsp;Custom Information&nbsp;</span></td>
			<td background="images/gradientbg.gif"></td>
		</tr>
		
		<tr>
			<td background="images/title.gif" nowrap width="1"><img src="images/titleleft.gif" width="1" height="16" vspace="0" hspace="0"></td>
			<td background="images/title.gif" nowrap><span class="header1">&nbsp;&nbsp;Field Name&nbsp;</span></td>
			...
			<td background="images/title.gif" nowrap><span class="header1">&nbsp;&nbsp;Field Data&nbsp;</span></td>
		...
		<tr bgcolor="#ffffff">
			<td></td>
			<td valign="top" nowrap>&nbsp;&nbsp;<?php print trim($row["NameField"]);?>&nbsp;</td>
			<td></td>
			<td valign="top" nowrap>&nbsp;&nbsp;<?php print trim($row["Data"]);?>&nbsp;</td>
			<td></td>
		</tr>
