<?php 
	function _sla_search($slaid = "",$slaname="",$mandatory = 1,$slasearchcriteria = "",$strOtherInputs = "")
	{
		...
		if($slasearchcriteria=="")
		{
			...
			$strSQL = "select pk_slad_id,slad_id,fk_ssla from itsmsp_slad";
			...
			$template = "<tr style='cursor:pointer;' criteria='[:rs.pk_slad_id.htmlvalue]' slaid='[:rs.pk_slad_id.htmlvalue]' fk_sla='[:rs.fk_ssla.htmlvalue]' slaname='[:rs.slad_id.htmlvalue]' onclick='_set_sla_searchcriteria(this);'><td width='100%'>[:rs.slad_id.htmlvalue]</td><td><img src='client/_system/images/icons/arrow.jpg'></td></tr><tr><td colspan='3'><div class='seperator'><div style='display:none;'></div></div></td></tr>";
		...
		{
			$strSQL = "select fk_priority from itsmsp_slad_priority where flg_sla=1 and fk_slad="._swm_db_pfs($slasearchcriteria);
			$strHTML .= _get_priority_list($strSQL);
		}
...
<?php 			
	...
	function _get_priority_list($strSQL)
	{
		...
		$template = "<tr style='cursor:pointer;' priority='[:rs.fk_priority.htmlvalue]' onclick='_set_sla_search(this);'><td width='100%'>[:rs.fk_priority.htmlvalue]</td><td><img src='client/_system/images/icons/arrow.jpg'></td></tr><tr><td colspan='3'><div class='seperator'><div style='display:none;'></div></div></td></tr>";
