<?php
	...
	$strCatID = $_POST['catid'];
	$boolNoSQLInjection = ($boolNoSQLInjection ? _validate_url_param($strCatID,"sqlparamstrict") : false);
	...
	$strSelect = "SELECT pk_auto_id, fk_cat_id FROM userdb_kbnotif ";
	$strWhere = "WHERE fk_keysearch = '".PrepareForSql($strWssCustId)."' ";
	if ($strCatID!="")
	{
		$strWhere .= "AND fk_cat_id = '".PrepareForSql($strCatID)."'";
	}
