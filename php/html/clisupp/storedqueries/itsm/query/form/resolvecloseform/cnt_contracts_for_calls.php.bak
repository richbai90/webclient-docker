<?php
	...
	//-- command
	$sqlDatabase = "swdata";
	$sqlCommand = "SELECT count(*) as cnt FROM config_reli, cmn_rel_opencall_ci WHERE fk_parent_id = '" .PrepareForSql($strContract). "' AND fk_child_id = cmn_rel_opencall_ci.fk_ci_auto_id AND cmn_rel_opencall_ci.fk_callref IN (".$inCallrefs.")";
?>