<?php
	...
	$_STATICSQL["arch_prodsvs"] = "id in ('ARCH/EDITING/', 'ARCH/VISUAL/')"; // You will need to change this filter to show the production services groups in the webclient form
