<?php
	...
	//-- get services customer is subscribed too - used in global.js oService.get_site_services
	...
	if($strSetting=="False")
		$strSetting = false;
	$res = $service->get_site_services($_POST['sid'],($_POST['bs']=="true" || $_POST['bs']=="1"),$strSetting,$strCallColumn);
