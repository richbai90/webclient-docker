<?php
	...
	//-- get services customer is subscribed too - used in global.js oService.get_organisition_services
	...
	if($strSetting=="False")
		$strSetting = false;
	$res = $service->get_organisation_services($_POST['oid'],($_POST['bs']=="true" || $_POST['bs']=="1"),$strSetting,$strCallColumn);
