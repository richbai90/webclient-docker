<?php
	...
	else
	{
		...
		//--Old Code Start
		/*$strSQL = "update itsm_oc_uri set nindex = ". $intSeq ." where pk_ocuri_id = ". $intUpID;
		$result	= SqlExecute("swdata",$strSQL);
		if($result==-1)	{
			throwProcessErrorWithMsg("Unable to update URI. Please contact your Administrator.");
		}
		throwSuccess(1);*/
		//--Old Code End
