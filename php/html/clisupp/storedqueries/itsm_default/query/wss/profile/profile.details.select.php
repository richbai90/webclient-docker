<?php
	...
	$strSelect = "SELECT firstname, surname, email, mobiletel, location, twitter_id, twitter_id_notify FROM userdb ";
	$strWhere  = "WHERE keysearch = '".PrepareForSql($strWssCustId)."'";
