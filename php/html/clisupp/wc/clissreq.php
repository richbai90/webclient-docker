<?php 
	...
	swdebug_print("CLISSREQ.PHP SessionID: " . $SwAnalystWebSession);

	if($con && $con < 33)
	{
		$source = $HTTP_POST_FILES['clissdata']['tmp_name'];

		if(swhd_sendcommand($con, "CLOSE ISSUE " . $issueref))		// Start the transaction
		{
