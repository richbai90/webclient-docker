<?php 
	...
	swdebug_print("DAFREC.PHP SessionID: " . $SwAnalystWebSession);

	if($con && $con < 33)
	{
		$source = $HTTP_POST_FILES['dafdata']['tmp_name'];

		if(swhd_sendcommand($con, "DELETE ATTACHMENT FROM CALL " . $callref))		// Start the transaction
		{
