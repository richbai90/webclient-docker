<?php
	//-- will do a table update based on gen settings table
	//-- if fails exits
	include_once("itsm_default/xmlmc/helpers/update.dbrecord.php");
	...
	function profile_updok()
	{
		...
		echo "<font style='color:green'>Settings were successfully updated.</font>";
	}
	profile_updok();
?>
