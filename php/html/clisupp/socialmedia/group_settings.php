...
<html>
	<head>
		<title>Group Settings - Supportworks Social Media</title>
	...
	<body>
		...
		<!-- ********** Start page body **********-->		
							...
							<div id="swtInfoBody">
								<h2>Managing Support Group Settings</h2>
								<p>When performing request actions, automatic updates can be sent to a customer via Twitter where the customer Twitter ID is set against a customer record.  <br/><br/>This form enables you to select which Twitter profile you would like such tweets to be sent from.  Select a support group, select the Twitter profile to be used when sending the Tweet and then click to update the settings.</p>
									...
									<tr>
										<td style="vertical-align:top;">
											...
											<?php 												$SwSocialMedia = new SwSocialMedia();
												$SwSocialMedia->listSwGroupsForGenSettings();
											?>
											</div>
										</td>
										<td style="vertical-align:top;">
											<div id="assocprofiles" class="assocanalysts"></div>
										</td>
									</tr>
								</table>
