	...
	<tr>
		<td width="75%" noWrap valign="top">
			...
			<div class="sectionHead">
				...
				<tr>
					<td class="right" valign="top"><?php echo  swdti_getcoldispname("userdb.costcenter"); ?> :</td><td><span><?php echo cmn_fcvformat($rsME->xf('costcenter'),"userdb.costcenter");?></span></td>
				</tr>
				<tr>
					<td class="right" valign="top"><?php echo  swdti_getcoldispname("userdb.site"); ?> :</td><td><span><?php echo cmn_fcvformat($rsME->xf('site'),"userdb.site");?></span></td>
				</tr>
				<tr>
