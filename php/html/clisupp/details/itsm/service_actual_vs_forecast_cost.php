<?php 	session_start();
	...
	$height = "300px";
	$chartType = "MSLine";
	$dataURL = "charts/actual_vs_forecast_cost.php";
	...
	if(!$rsFolio->eof)
	{
		$urlParams = "targetid=".$serviceID."&sessid=".$sessid;
	}
...
<body class="activepagebody" onload="resize_charts();" onresize="resize_charts();" style="min-width:240px;">

<!--
		<div class="boxContent">
		<div class="spacer">&nbsp;</div>-->
				<!--<h1>Actual vs Forecasted Cost</h1>-->
				...
				<div id="swtInfoBody">
						<div class="sectionHead">
								<table class="sectionTitle">
										<tr>
											<td class="titleCell" noWrap><h1><center>Actual vs Forecasted Cost<center></h1></td>
											<td class="endCell"></td>
										</tr>
								</table>	
						</div>
