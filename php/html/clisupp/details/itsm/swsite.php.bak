<?php 
	...
	if(gv('site')!="")	$site_sitename = gv('site');
	if($site_sitename=="")$site_sitename= gv('site_name');
	...
	$intIncCount = $swconn->GetRecordCount("opencall","site = '" . pfs($rsME->f("site_name")) . "' and status < 15 and  status != 6");
