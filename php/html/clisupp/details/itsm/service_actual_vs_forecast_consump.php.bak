<?php 	session_start();
	...
	$height = "300px";
	$chartType = "MSLine";
	$dataURL = "charts/actual_vs_forecast_consump.php";
...
<!--
		...
		<div class="spacer">&nbsp;</div>-->
				...
				<!--<h1>Actual vs Forecasted Consumption</h1>-->
				...
				<div id="swtInfoBody">
						<div class="sectionHead">
								<table class="sectionTitle">
										<tr>
											<td class="titleCell" noWrap><h1><center>Actual vs Forecasted Consumption<center></h1></td>
											<td class="endCell"></td>
										</tr>
								</table>	
						</div>
