	...
	<tr>
		<td width="75%" noWrap valign="top">
			...
			<div class="sectionHead">
				<table class="sectionTitle">
					<tr>
						<td class="titleCell" noWrap><h1><?php echo swdti_getcoldispname("costcent.costcenter");?> Details For <?php echo htmlentities($costcent_ccname,ENT_QUOTES,"UTF-8");?></h1></td>
						<td class="endCell"></td>
					</tr>
				</table>	
